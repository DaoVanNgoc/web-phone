<%-- 
    Document   : register
    Created on : Apr 3, 2023, 10:00:05 PM
    Author     : LENOVO
--%>
        ...
        <div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <div class="fadeIn first">
                    <img src="https://s3.amazonaws.com/thumbnails.venngage.com/template/fc8535df-be09-4c80-8ea5-a69a34b2318e.png" id="icon" alt="User Icon" />
                </div>

                <!-- Login Form -->
                <form action="RegisterSevlet" method="get">
